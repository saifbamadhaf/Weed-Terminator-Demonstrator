...
private:
  ...
  std::vector<double> actuator_offset_;
  ...
  void actuator_to_joint(std::vector<double> actuator_values, std::vector<double>& joint_values, std::vector<double> joint_commands);
  void joint_to_actuator(std::vector<double> joint_values, std::vector<double>& actuator_values);
  ...
  enum class transmission_type_t { NONE, SIMPLE, TBOT, ADD};

  transmission_type_t transmission_in_use_;
};
}  // namespace odrive_hardware_interface
