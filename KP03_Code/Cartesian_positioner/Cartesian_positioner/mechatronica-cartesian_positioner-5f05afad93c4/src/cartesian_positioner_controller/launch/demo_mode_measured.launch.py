...
def generate_launch_description():
    ...
    touch_params = load_yaml("cartesian_positioner_controller", "config/touch_parameters.yaml")
    ...
    positioner_controller = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, touch_params],
    ...
    return LaunchDescription(declared_arguments + [publish_world_tf, positioner_controller, tracking_node, detector, conveyor_sim, rviz])
